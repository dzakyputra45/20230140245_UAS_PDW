...
<head>
    <meta charset="UTF-8">
    <title>STUDYKU - Panel Mahasiswa - <?php echo $pageTitle ?? 'Dashboard'; ?></title>
            ...
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <span class="text-white text-2xl font-bold">STUDYKU</span>
                    </div>
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            ...
                            <a href="../praktikum.php" class="<?php echo ($activePage == 'katalog') ? $activeClass : $inactiveClass; ?> px-3 py-2 rounded-md text-sm font-medium">Katalog Praktikum</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="hidden md:block">
                    <div class="ml-4 flex items-center md:ml-6">
                        <span class="text-white text-sm mr-4">Selamat datang, <?php echo htmlspecialchars($_SESSION['nama']); ?></span>

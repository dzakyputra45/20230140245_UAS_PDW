...
<head>
    <meta charset="UTF-8">
    <title>STUDYKU - Panel Asisten - <?php echo $pageTitle ?? 'Dashboard'; ?></title>
...
<div class="flex h-screen">
    <aside class="w-64 bg-gray-800 text-white flex flex-col">
        <div class="p-6 text-center border-b border-gray-700">
            <h3 class="text-xl font-bold">STUDYKU</h3>
            <p class="text-sm text-gray-400 mt-1">Panel Asisten - <?php echo htmlspecialchars($_SESSION['nama']); ?></p>
        </div>
        <nav class="flex-grow">
